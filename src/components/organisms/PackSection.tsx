      ...
      <div className="mx-auto max-w-7xl space-y-12">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {packCards.map((card) => (
            <div
              key={card.title}
              className="flex flex-col gap-4 rounded-2xl bg-[--slate-900] p-6 shadow-md shadow-black/20 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_0_24px_rgba(230,51,41,0.25)]"
            >
