        ...
        <div className="grid grid-cols-2 gap-6 lg:grid-cols-4">
          {stats.map((stat) => (
            <div key={stat.label} className="text-center">
              <p className="bg-gradient-to-r from-[var(--brand-red)] to-[var(--accent-orange-text)] bg-clip-text font-(family-name:--font-sora) text-4xl font-black tracking-tight text-transparent sm:text-5xl">
                {stat.value}
              </p>
